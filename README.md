...
> **R:** Porque el programa.c se reserva principalmente para la lógica ejecutable, mientras que el programa.i incluye muchísimas otras cosas, como lo son los #include expandidos o comentarios.
...
> **R:**Esto se debe a que el compilador elimina todos los comentarios ya que solo utiliza los ejecutables.
...
> **R:**La información son lineas del preprocesador y me indican el número de línea y el archivo de origen del código que sigue
...
> **R:**El .cfi_startproc encuentra el inicio del bloque para ejecutar, y el pushq guarda el valor.
...
> **R:**Porque programa.o solo referencia la función sin definirla (U), mientras que matematica.o contiene su definición (T)
...
> **R:**Son funciones de la biblioteca dinámica y son resueltas por el cárgador dinámico cuando el programa las ejecute.
...
> **R:**La macro función es un texto mas que nada declarativo de una función real en la etapa de preprocesamiento y se elimina a la hora de compilar. La función real india el código a ejecutar, la lógica ejecutable por asi decirle del programa y se mantiene hasta el enlazado. Esta última tiene verificación de tipos.
...
> **R:**Ambos simbolos me indican una definición, aún así, recibir un T en la salida del nm me dice que se ubica en la sección de texto y los D se encuentran en sección de datos.
...
> **R:**linux-vdso.so.1 (0x00007fff3a57a000)
        libc.so.6 => /lib/x86_64-linux-gnu/libc.so.6 (0x000075afdda14000)
        /lib64/ld-linux-x86-64.so.2 (0x000075afddc34000)

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:**Porque se enlaza automaticamente al generar el ejecutable.
